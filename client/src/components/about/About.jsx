          ...
          <div className="container">
            <div className="hero-inner">
              <div className="hero-copy">
                <h1 className="hero-title mt-0">PearlBg</h1>
                <p className="hero-paragraph">
                  Намери най-подходящото бижу на достъпна цена
                </p>
                 ...
                 <div className="simple-card">
                   <div className="card-header" id="headingOne">
                     <h5 className="mb-0">
                       ...
                       >
                         <span className="arrow-container" /> Как продам бижуто си?
                       </button>
                     </h5>
                   </div>
                   <div
                 ...
                 <div className="simple-card">
                   <div className="card-header" id="headingThree">
                     <h5 className="mb-0">
                       ...
                       >
                         <span className="arrow-container" /> Безопасно ли е?
                       </button>
                     </h5>
                   </div>
                   <div
